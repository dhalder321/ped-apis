...
class Utility:
  ...
  TRANSFORM_EXECUTIVE_SUMMARY_PROMPT_TYPE =   "TRANSFORM_EXECUTIVE_SUMMARY"
  TRANSFORM_IMPROVEMENT_SUGGESTIONS_PROMPT_TYPE =   "TRANSFORM_IMPROVEMENT_SUGGESTIONS"
  TRANSFORM_ONLINE_RESOURCES_PROMPT_TYPE =   "TRANSFORM_ONLINE_RESOURCES"
  TRANSFORM_OBJECTIVE_QUESTIONS_PROMPT_TYPE =   "TRANSFORM_OBJECTIVE_QUESTIONS"
  TRANSFORM_SUBJECTIVE_QUESTIONS_PROMPT_TYPE =   "TRANSFORM_SUBJECTIVE_QUESTIONS"
  TRANSFORM_SUMMARIZE_PROMPT_TYPE =   "TRANSFORM_SUMMARIZE"
  ...
  PROMPT_TYPE2FILE_NAME = {
    ...
    TRANSFORM_EXECUTIVE_SUMMARY_PROMPT_TYPE :   "TRANSFORM_EXECUTIVE_SUMMARY_PROMPT.txt",
    TRANSFORM_IMPROVEMENT_SUGGESTIONS_PROMPT_TYPE :   "TRANSFORM_ESSAY_IMPROVEMENT_PROMPT.txt",
    TRANSFORM_ONLINE_RESOURCES_PROMPT_TYPE :   "TRANSFORM_ONLINE_RESOURCES_PROMPT.txt",
    TRANSFORM_OBJECTIVE_QUESTIONS_PROMPT_TYPE :   "TRANSFORM_OBJECTIVE_QUESTIONS_PROMPT.txt",
    TRANSFORM_SUBJECTIVE_QUESTIONS_PROMPT_TYPE :   "TRANSFORM_SUBJECTIVE_QUESTIONS_PROMPT.txt",
    TRANSFORM_SUMMARIZE_PROMPT_TYPE :   "TRANSFORM_SUMMARIZE_PROMPT.txt",
