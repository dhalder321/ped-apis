...
# 2006 - document record could not be updated in database
...
def generateDocumentFromPresentation(event, context):
    ...
    if 'httpMethod' in event and event['httpMethod'] == 'POST':
        ...
        try:
            ...
            # check for minimum length of the text- min 100 chars
            if len(retVal) < 100:
            ...
            presignedURL = Utility.uploadDocumentinHTMLtoS3(trmsText, localDocFileName, \
                                                            localDocFileLocation, s3filePath)
