...
class inputProcessor:
    ...
    @staticmethod
    def storeInput(inputType, **inputValue):
        ...
        if inputType == "pptContentBase64":
            ...
            #process the ppt file
            return inputProcessor.storeDOCFileContentBase64(inputValue["fileContentBase64"], \
                    inputValue["docFilename"], inputValue["userid"], inputValue["tran_id"])
        ...
        # inputs required : fileContentBase64, pptFilename, userid, tran_id 
            ...
            #process the ppt file
            return inputProcessor.storePDFFileContentBase64(inputValue["fileContentBase64"], \
                    inputValue["pdfFilename"], inputValue["userid"], inputValue["tran_id"])    
    ...
    def storeDOCFileContentBase64(fileContentBase64, docFileName, userid, tran_id):
    ...
    def storePDFFileContentBase64(fileContentBase64, pdfFileName, userid, tran_id):
